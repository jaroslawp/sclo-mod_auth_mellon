...
mkdir -p %{buildroot}%{?scl:%_scl_root}/run/mod_auth_mellon


%if 0%{?scl:1}
sed -i 's#/run/#%{_scl_root}/run/#' %{buildroot}%{_httpd24_confdir}/auth_mellon.conf
sed -i 's#/run/#%{_scl_root}/run/#' %{buildroot}%{_scl_root}/%{_tmpfilesdir}/mod_auth_mellon.conf
%endif
...
%{_scl_root}/%{_tmpfilesdir}/mod_auth_mellon.conf
%{_libexecdir}/mod_auth_mellon
%dir %{_scl_root}/run/mod_auth_mellon/
%else
